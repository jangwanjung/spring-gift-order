...
public class WishListController {
    ...
    @GetMapping
    public ResponseEntity<Page<WishListResponseDto>> getWishList(@LoginMember Member member, @PageableDefault(size = 10, sort = "id", direction = Sort.Direction.DESC) Pageable pageable) {
